                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-md-4 m-b-10px">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- Data Diagonal Dan Posisi -->                      
                                    <input id="upload-img-2" name="photo_text" type="file" onchange="document.getElementById('blah2').src = window.URL.createObjectURL(this.files[0])">
...
@section('myscript')
    ...
    <script>
        ...
        document.querySelector('.save-foto-diri').addEventListener('click',(e)=>{
            ...
            document.querySelector('#data-satu').value = JSON.stringify( cropperB.getData() );
            document.querySelector('#data-dua').value = JSON.stringify( cropperB.getCanvasData() );
        });
        // =============
        // FOTO DIRI
    </script>
